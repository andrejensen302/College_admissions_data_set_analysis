...
############R Script for section 1 of assignment############
...
############R Script for section 2 of assignment############
...
############R Script for section 3 of assignment############
...
#so we are looking at similar degree-granting universities. What other criteria are we using to subset?
